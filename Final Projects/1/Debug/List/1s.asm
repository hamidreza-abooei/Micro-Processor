...
_0x3:
	.DB  0x57,0x41,0x49,0x54,0x49,0x4E,0x47
_0x4:
	.DB  0x48,0x61,0x6D,0x69,0x64,0x72,0x65,0x7A
	.DB  0x61
_0x5:
	.DB  0x41,0x62,0x6F,0x6F,0x65,0x69
_0x6:
	.DB  0x57,0x52,0x4F,0x4E,0x47
...
; 0000 0095 for (i=0;waiting[i]!='\0';i++){
	...
	CLR  R5
_0x2B:
	LDI  R26,LOW(_waiting)
	LDI  R27,HIGH(_waiting)
	RCALL SUBOPT_0x1
	BREQ _0x2C
