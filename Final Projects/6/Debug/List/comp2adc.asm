...
; 0000 0022          if (flag == 0){
	TST  R4
	BRNE _0x4
; 0000 0023             OCR2 = OCR2+1;
	IN   R30,0x23
	SUBI R30,-LOW(1)
	OUT  0x23,R30
; 0000 0024             if (OCR2 == 255){
	IN   R30,0x23
	CPI  R30,LOW(0xFF)
	BRNE _0x5
; 0000 0025                 flag = 1;
...
; 0000 0055 // Function: Bit7=Out Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0056 DDRD=(1<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(128)
	OUT  0x11,R30
; 0000 0057 // State: Bit7=0 Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 005C // Clock value: 8000.000 kHz
; 0000 005D // Mode: Fast PWM top=0xFF
; 0000 005E // OC2 output: Non-Inverted PWM
; 0000 005F // Timer Period: 0.032 ms
; 0000 0060 // Output Pulse(s):
; 0000 0061 // OC2 Period: 0.032 ms Width: 0 us
; 0000 0062 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0063 TCCR2=(1<<PWM2) | (1<<COM21) | (0<<COM20) | (1<<CTC2) | (0<<CS22) | (0<<CS21) | (1<<CS20);
	LDI  R30,LOW(105)
	OUT  0x25,R30
...
; 0000 0068 TIMSK=(0<<OCIE2) | (1<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(64)
	OUT  0x39,R30
; 0000 0069 
; 0000 006A // Analog Comparator initialization
; 0000 006B // Analog Comparator: On
...
; 0000 0070 // Interrupt on Output Toggle
; 0000 0071 // Analog Comparator Input Capture by Timer/Counter 1: Off
; 0000 0072 ACSR=(0<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (1<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(8)
	OUT  0x8,R30
