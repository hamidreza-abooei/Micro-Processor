...
; 0000 001D // Function: Bit7=In Bit6=Out Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 001E DDRB=(0<<DDB7) | (1<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(64)
	OUT  0x17,R30
; 0000 001F // State: Bit7=T Bit6=0 Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 002A DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
...
; 0000 0064 // USART Receiver: Off
; 0000 0065 // USART Transmitter: On
; 0000 0066 // USART Mode: Asynchronous
; 0000 0067 // USART Baud Rate: 4800
; 0000 0068 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 0069 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (0<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(8)
	OUT  0xA,R30
...
; 0000 007C // SPI Type: Slave
; 0000 007D // SPI Clock Rate: 2000.000 kHz
; 0000 007E // SPI Clock Phase: Cycle Start
; 0000 007F // SPI Clock Polarity: Low
; 0000 0080 // SPI Data Order: MSB First
; 0000 0081 SPCR=(1<<SPIE) | (1<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (0<<SPR0);
	LDI  R30,LOW(192)
	OUT  0xD,R30
; 0000 0082 SPSR=(0<<SPI2X);
	LDI  R30,LOW(0)
	OUT  0xE,R30
; 0000 0083 
; 0000 0084 // Clear the SPI interrupt flag
; 0000 0085 #asm
; 0000 0086     in   r30,spsr
    in   r30,spsr
; 0000 0087     in   r30,spdr
    in   r30,spdr
; 0000 0088 #endasm
; 0000 0089 
