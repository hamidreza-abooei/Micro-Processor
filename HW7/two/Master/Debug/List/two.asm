...
;unsigned char status = 0; //0:"C" ss1    1:PORTC ss1    2:PORTD ss1     3:"C"ss2    4:PORTC ss2     5:PORTD ss2
...
; 0000 004A // Function: Bit7=Out Bit6=In Bit5=Out Bit4=Out Bit3=Out Bit2=In Bit1=In Bit0=In
; 0000 004B DDRB=(1<<DDB7) | (0<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(184)
	OUT  0x17,R30
; 0000 004C // State: Bit7=0 Bit6=T Bit5=0 Bit4=0 Bit3=0 Bit2=T Bit1=T Bit0=T
...
; 0000 00A1 // SPI Type: Master
; 0000 00A2 // SPI Clock Rate: 2000.000 kHz
; 0000 00A3 // SPI Clock Phase: Cycle Start
; 0000 00A4 // SPI Clock Polarity: Low
; 0000 00A5 // SPI Data Order: MSB First
; 0000 00A6 SPCR=(1<<SPIE) | (1<<SPE) | (0<<DORD) | (1<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (0<<SPR0);
	LDI  R30,LOW(208)
	OUT  0xD,R30
; 0000 00A7 SPSR=(1<<SPI2X);
	LDI  R30,LOW(1)
	OUT  0xE,R30
; 0000 00A8 
; 0000 00A9 // Clear the SPI interrupt flag
; 0000 00AA #asm
; 0000 00AB     in   r30,spsr
    in   r30,spsr
; 0000 00AC     in   r30,spdr
    in   r30,spdr
; 0000 00AD #endasm
; 0000 00AE 
