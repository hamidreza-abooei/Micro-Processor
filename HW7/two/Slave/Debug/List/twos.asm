...
;unsigned char status = 0;   // 0:undefined      1:c     2:PORTC     3:PORTD
...
; 0000 0023         status = 1;
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 0024     }else if (status == 1){
	RJMP _0x6
_0x3:
	LDI  R30,LOW(1)
	CP   R30,R5
	BRNE _0x7
; 0000 0025         PORTC = data;
	OUT  0x15,R17
; 0000 0026         status = 2;
	LDI  R30,LOW(2)
	MOV  R5,R30
; 0000 0027     }else if (status == 2){
	RJMP _0x8
_0x7:
	LDI  R30,LOW(2)
	CP   R30,R5
	BRNE _0x9
; 0000 0028         PORTD = data;
	OUT  0x12,R17
; 0000 0029         status = 0;
	CLR  R5
; 0000 002A     }
...
; 0000 003A // Function: Bit7=Out Bit6=Out Bit5=In Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 003B DDRB=(1<<DDB7) | (1<<DDB6) | (0<<DDB5) | (1<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(208)
	OUT  0x17,R30
; 0000 003C // State: Bit7=0 Bit6=0 Bit5=T Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0047 DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(255)
	OUT  0x11,R30
...
; 0000 0092 // SPI Clock Rate: 2*2000.000 kHz
; 0000 0093 // SPI Clock Phase: Cycle Start
; 0000 0094 // SPI Clock Polarity: Low
; 0000 0095 // SPI Data Order: MSB First
; 0000 0096 SPCR=(1<<SPIE) | (1<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (0<<SPR0);
	LDI  R30,LOW(192)
	OUT  0xD,R30
; 0000 0097 SPSR=(1<<SPI2X);
	LDI  R30,LOW(1)
	OUT  0xE,R30
; 0000 0098 
