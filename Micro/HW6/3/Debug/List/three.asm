...
; 0000 0023     unsigned char a = 'A';
; 0000 0024     UDR = a;
	ST   -Y,R17
;	a -> R17
	LDI  R17,65
	OUT  0xC,R17
; 0000 0025     PORTA.0 = ~PORTA.0;
	SBIS 0x1B,0
	RJMP _0x3
	CBI  0x1B,0
	RJMP _0x4
...
; 0000 0051 // Clock value: 1000.000 kHz
...
; 0000 0057 // Timer Period: 3.101 ms
...
; 0000 005C TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 005D TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (0<<CS11) | (1<<CS10);
	LDI  R30,LOW(9)
	OUT  0x2E,R30
...
; 0000 0061 ICR1L=0x00;
	OUT  0x26,R30
; 0000 0062 OCR1AH=0x0C;
	LDI  R30,LOW(12)
	OUT  0x2B,R30
; 0000 0063 OCR1AL=0x1C;
	LDI  R30,LOW(28)
	OUT  0x2A,R30
...
; 0000 007C // Communication Parameters: 8 Data, 1 Stop, No Parity
; 0000 007D // USART Receiver: Off
; 0000 007E // USART Transmitter: On
; 0000 007F // USART Mode: Asynchronous
; 0000 0080 // USART Baud Rate: 4800
; 0000 0081 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 0082 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (0<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(8)
	OUT  0xA,R30
; 0000 0083 UCSRC=(1<<URSEL) | (0<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (0<<UCPOL);
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 0084 UBRRH=0x00;
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 0085 UBRRL=0x0C;
	LDI  R30,LOW(12)
	OUT  0x9,R30
; 0000 0086 
