...
; 0000 0020      TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (0<<CS12) | (0<<CS11) | (1<<CS10);
	LDI  R30,LOW(1)
	OUT  0x2E,R30
; 0000 0021     TCNT1H=0xE0;
	LDI  R30,LOW(224)
	OUT  0x2D,R30
; 0000 0022     TCNT1L=0xC0;
	LDI  R30,LOW(192)
	OUT  0x2C,R30
; 0000 0023     // Timer(s)/Counter(s) Interrupt(s) initialization
; 0000 0024     TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (1<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(4)
	OUT  0x39,R30
; 0000 0025     PORTD.5=~PORTD.5;
	SBIS 0x12,5
	RJMP _0x3
	CBI  0x12,5
	RJMP _0x4
...
; 0000 002E TCNT1H=0xE0;
	LDI  R30,LOW(224)
	OUT  0x2D,R30
; 0000 002F TCNT1L=0xC0 ;
	LDI  R30,LOW(192)
	OUT  0x2C,R30
; 0000 0030 PORTD.5=~PORTD.5;
	SBIS 0x12,5
	RJMP _0x5
	CBI  0x12,5
	RJMP _0x6
...
; 0000 004D // Function: Bit7=In Bit6=In Bit5=Out Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 004E DDRD=(0<<DDD7) | (0<<DDD6) | (1<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(32)
	OUT  0x11,R30
; 0000 004F // State: Bit7=T Bit6=T Bit5=0 Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 008B // Analog Comparator: On
...
; 0000 0090 // Interrupt on Falling Output Edge
; 0000 0091 // Analog Comparator Input Capture by Timer/Counter 1: Off
; 0000 0092 ACSR=(0<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (1<<ACIE) | (0<<ACIC) | (1<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(10)
	OUT  0x8,R30
